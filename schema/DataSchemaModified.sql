...
(
    ...
    email
    ~ '^[a-z0-9][a-z0-9._-]*@[a-z][a-z0-9._-]*\\.[a-z]{2,}$'
  )
);
    ...
    (
        ...
        CONSTRAINT devices_type_allowed CHECK (device_type IN ('light','speaker','sensor-hub')),
        ...
        (
            ...
            room_id INTEGER NOT NULL REFERENCES rooms(room_id),
            CONSTRAINT sensors_type_allowed CHECK (sensor_type IN ('illumination','motion','noise')),
        ...
        (
            ...
            CONSTRAINT reco_type_allowed CHECK (reco_type IN ('light','music','safety'))
        );
        ...
        (
            ...
            preferred_light_level SMALLINT NOT NULL CHECK (preferred_light_level BETWEEN 0 AND 100),
